...
# ================================
log "Fetching latest GitHub Store release..."
API_URL="https://api.github.com/repos/rainxchzed/Github-Store/releases/latest"
...
FILENAME="Github.Store-${VERSION}_${PKG_ARCH}.deb"
DOWNLOAD_URL="https://github.com/rainxchzed/Github-Store/releases/download/${TAG}/${FILENAME}"
...
# INSTALL
# ================================
log "Installing GitHub Store..."
sudo apt install -y "$TMP_DEB"

success "GitHub Store ${VERSION} installed successfully!"
